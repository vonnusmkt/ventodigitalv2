...
class CrmStatusController extends Controller
{
    public function index()
    {
        ...
        $crmStatuses = CrmStatus::with(['file_bilhete'])->get();

        $crm_documents = CrmDocument::get();

        return view('admin.crmStatuses.index', compact('crmStatuses', 'crm_documents'));
    }
