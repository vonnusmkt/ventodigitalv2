...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Cc
    Route::delete('ccs/destroy', 'CcController@massDestroy')->name('ccs.massDestroy');
    Route::resource('ccs', 'CcController');

    // Contas
    Route::delete('conta/destroy', 'ContasController@massDestroy')->name('conta.massDestroy');
